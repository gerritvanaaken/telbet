<template>
	<div id="app" class="app">
		<header class="app__header">
			<h1 class="app__headline">#telbet</h1>
			...
			<div class="app__subline">The betting game for Tel Aviv 2019</div>
		</header>
...
export default {
	...
	methods: {
		fetchSongs () {
			axios.get(process.env.BASE_URL+'songs.json?v='+Date.now()).then(response => {
