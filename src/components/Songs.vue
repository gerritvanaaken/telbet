<template>
	<div class="songs">
		...
		<draggable :list="songs" @start="globalStoreCandidate" @end="globalRemoveCandidate" :sort="false" :group="{ name: 'songs', pull: 'clone', put: false }" animation="300" class="songs__scroller">
